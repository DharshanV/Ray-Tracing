...
int main() {
	...
	renderer.addModel(new Sphere(Vector3(-2, 0, -3), 1, Material(0.4f,0.4f,0.3f,32)));
	renderer.addModel(new Sphere(Vector3(2, 0, -5), 1, Material(0.3f, 0.2f, 0.6f,32)));
	renderer.addModel(new Sphere(Vector3(0, -1, -7), 1, Material(0.6f, 0.2f, 0.3f,32)));
